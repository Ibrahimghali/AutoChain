...
import { AlertCircle, CheckCircle, ExternalLink, Copy, Network } from "lucide-react"
...
export function BlockchainStatus({ isConnected, account, userRole, error }: BlockchainStatusProps) {
