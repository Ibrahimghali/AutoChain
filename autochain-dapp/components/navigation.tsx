...
import { Car, Home, Plus, ShoppingCart, History, Menu, X } from "lucide-react"
...
export function Navigation({ currentPath = "/", userRole = null, isConnected = false }: NavigationProps) {
